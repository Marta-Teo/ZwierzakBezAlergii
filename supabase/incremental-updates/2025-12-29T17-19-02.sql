...
-- ============================================================================
-- Wygenerowano: 29.12.2025, 18:19:02
-- 
-- INSTRUKCJA UŻYCIA:
...
INSERT INTO public.ingredients (id, name) VALUES
  ...
  (300, 'świeża wołowina black angus'),
  (301, 'kurczak (suszony)'),
  (302, 'indyk (suszony)'),
  (303, 'mięso kaczki (suszone)'),
  (304, 'białko drobiowe (hydrolizowane)'),
  (305, 'jajo'),
  (306, 'łupiny nasion babki płesznik'),
  (307, 'jabłka (suszone)'),
  (308, 'marchew (suszona)'),
  (309, 'żurawina (suszona)'),
  (310, 'jagnięcina (suszona)'),
  (311, 'łosoś (suszony)'),
  (312, 'batat(suszony)'),
  (313, 'lignoceluloza'),
  (314, 'łuski psyllium'),
  (315, 'suszone zioła'),
  (316, 'świeża dziczyzna'),
  (317, 'mięso królicze (suszone)'),
  (318, 'ziemniaki (suszony)'),
  (319, 'białko drobiowe (hydrolizowanego)'),
  (320, 'łupiny nasion babki płasznik'),
  (321, 'jabłko suszone'),
  (322, 'świeże mięso z kurczaka'),
  (323, 'mięso z kurczaka (suszone)'),
  (324, 'ryby (suszone)'),
  (325, 'mięso z indyka (suszone)'),
  (326, 'mięso z kaczki (suszone)'),
  (327, 'świeża konina'),
  (328, 'białko końskie (suszone)'),
  (329, 'groch (suszony)'),
  (330, 'hydrolizat wątroby'),
  (331, 'suszona pulpa buraczana (odcukrzona)'),
  (332, 'wytłoki jabłkowe'),
  (333, 'wytłoki z marchwi'),
  (334, 'ściany komórkowe drożdży'),
  (335, 'kwiaty nagietka')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name;
...
-- Insert 308 record(s) (ignoring duplicates)
...
INSERT INTO public.foods (id, name, brand_id, size_type_id, age_category_id, ingredients_raw, image_url) VALUES
  ...
  (18, 'Purizon Adult, wołowina Black-Angus i indyk', 8, 2, 3, '20% świeżej wołowiny Black Angus, 19% świeżego łososia, 18% kurczaka (suszonego), 8% indyka (suszonego), ziemniak (suszony), batat (suszony), 7% tłuszczu drobiowego, 3% mięsa kaczki (suszonego), 3% białka drobiowe (hydrolizowanego), groszek, 1% jajo (suszone), 1% oleju z łososia, siemię lniane, łupiny nasion babki płesznik, jabłka (suszone), marchew (suszona), żurawina (suszona), zioła suszone (szpinak, tymianek, oregano, szałwia, pietruszka, majeranek, rumianek, nasiona anyżu, kozieradka, nagietek, mięta pieprzowa), inulina z cykorii.', '/images/foods/purizon-adult-wolowina.jpg'),
  (19, 'Purizon Adult jagnięcina i łosoś', 8, 2, 3, '22 % świeżej jagnięciny, 19 % świeżego łososia, 12 % kurczaka (suszonego), 8 % jagnięciny (suszonej), 8 % łososia (suszonego), ziemniak (suszony), słodki ziemniak (suszony), 6 % tłuszczu drobiowego, 4 % białka drobiowego (hydrolizowanego), groszek, 1 % oleju z łososia, lignoceluloza, siemię lniane, łuski psyllium, jabłka (suszone), marchew (suszona), żurawina (suszona), suszone zioła (szpinak, tymianek, oregano, szałwia, pietruszka, majeranek, rumianek, anyż, kozieradka, nagietek, mięta pieprzowa), inulina z cykorii.', '/images/foods/purizon-adult-jagniecina-losos.jpg'),
  (20, 'Purizon Adult dziczyzna i królik', 8, 2, 3, '39% świeżej dziczyzny (18% mięsa z jelenia, 17% sarniny, 4% mięsa z renifera), 14% kurczaka (suszonego), 8% mięsa króliczego (suszonego), 8% mięsa z kaczki (suszonego), ziemniaki (suszony), batat (suszony), 6% tłuszczu drobiowego, groch, 3% białka drobiowego (hydrolizowanego), 1% jajo (suszonego), 1% oleju z łososia, lignoceluloza, siemię lniane, łupiny nasion babki płasznik, jabłko suszone, marchew suszona, żurawina suszona, zioła suszone (szpinak, tymianek, oregano, szałwia, pietruszka, majeranek, rumianek, nasiona anyżu, kozieradka, nagietek, mięta pieprzowa), inulina z cykorii', '/images/foods/purizon-adult-dziczyzna.jpg'),
  (21, 'Purizon Adult kurczak i ryba', 8, 2, 3, '23 % świeże mięso z kurczaka, 17 % mięso z kurczaka (suszone), 17 % świeży łosoś, 8 % ryby (suszone; śledź, gładzica, dorsz, mintaj), ziemniak (suszony), słodki ziemniak (suszony), 5 % tłuszczu drobiowego, 4 % mięsa z indyka (suszonego), 2 % mięsa z kaczki (suszonego), 2 % białka drobiowego (hydrolizowanego), groszek, 1 % jaja (suszonego), 1 % oleju z łososia, siemię lniane, łuski psyllium, jabłka (suszone), marchew (suszona), żurawina (suszona), suszone zioła (szpinak, tymianek, oregano, szałwia, pietruszka, majeranek, rumianek, anyż, kozieradka, nagietek, mięta pieprzowa), inulina z cykorii', '/images/foods/purizon-adult-kurczak-ryba'),
  (22, 'Purizon Single Meat Adult konina z batatami i kwiatami nagietka', 8, 2, 3, '30% świeżej koniny, 14% białka końskiego (suszonego), 14% batata (suszonego), białko grochu, groch (suszony), 3,5% oleju z łososia, 3% hydrolizatu wątroby, drożdże piwne (suszone), olej słonecznikowy, siemię lniane, białko ziemniaczane, suszona pulpa buraczana (odcukrzona), chlorek sodu, 0,2% wytłoków jabłkowych, 0,2% wytłoki z marchwi, 0,2% ściany komórkowe drożdży (bogate w oligosacharydy mannanowe i beta-glukany), 0,1% inulina z cykorii, 0,1% żurawina (suszona), 0,05% kwiaty nagietka, mieszanka ziół (rozmaryn, liście mniszka lekarskiego, pietruszka, rumianek, pokrzywa, babka płesznik, dziurawiec)', '/images/foods/purizon-adult-konina.jpg')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
...
-- Insert 375 record(s) (ignoring duplicates)
...
-- Ingredients: 328
-- Allergens: 59
-- Ingredient-Allergen mappings: 308
-- Foods: 21
-- Food-Ingredient mappings: 375
-- Articles: 5
